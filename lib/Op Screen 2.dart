...
import 'Op Screen 3.dart';

class OpScreen2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        // if (details.delta.dx > 0) { Navigator.of(context).push(_Prev()); }
        //
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Fund your account to play our \n real-money games or play as a guest in a free game!",
...
Route _Next() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => OpScreen3(),
...
// Route _Prev() {
//   return PageRouteBuilder(
//     pageBuilder: (context, animation, secondaryAnimation) => OpScreen1(),
//     transitionsBuilder: (context, animation, secondaryAnimation, child) {
//       const begin = Offset(1.0, 0.0);
//       const end = Offset.zero;
//       const curve = Curves.ease;
